...
export const Auth = () => {
  ...
  return (
    <>
      <div className="flex h-screen w-full items-center justify-center bg-gray-700 bg-cover bg-no-repeat">
        <div className="rounded-xl bg-gray-400 bg-opacity-50 px-16 py-10 shadow-xl backdrop-blur-md max-sm:px-8">
