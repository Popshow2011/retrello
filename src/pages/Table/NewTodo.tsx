...
export const NewTodo = () => {
  ...
  const { mutate, isLoading } = useMutation({
    mutationFn: () => axios.post('https://jsonplaceholder.typicode.com/todos', newTodo),
    onSuccess: (data) => {
      console.log('TODO успешно добавлен:', data);
      navigate('/');
    },
    onError: (error) => {
        ...
        <div className="relative top-1/4 left-0 right-0 m-auto w-full max-w-md max-h-full">
          <div className="relative  bg-white rounded-lg shadow dark:bg-gray-700">
            <div className="px-6 py-6 lg:px-8">
              <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Добавление нового TODO</h3>
