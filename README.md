...
- [ ] Развернуть проект
- [ ] Добавить talilwindcss
- [ ] Добавить и настроить роутер (React-router)
- [ ] Добавить axios
- [ ] Получение данных по тудушкам из jsonplaceholder
- [ ] Валидация полученных данных по схеме через ZOD
- [ ] Добавление и настройка хранилища Rect-query
- [ ] Открытие в попапе тудушки по роуте
